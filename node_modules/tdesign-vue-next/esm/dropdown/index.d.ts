...
export declare const DropdownItem: {
    new (...args: any[]): {
        ...
        }>> & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "active" | "content" | "path" | "disabled" | "divider" | "hasChildren">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
...
export declare const DropdownMenu: {
    new (...args: any[]): {
        ...
        }>> & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "maxHeight" | "options" | "maxColumnWidth" | "minColumnWidth">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
