...
import { s as set_1 } from '../_chunks/dep-808dde7b.mjs';
import { i as isNil_1 } from '../_chunks/dep-88e40e6a.mjs';
import '../_chunks/dep-a48de419.mjs';
import { _ as _copyObject, k as keysIn_1 } from '../_chunks/dep-2a7dc5c7.mjs';
import { _ as _createAssigner } from '../_chunks/dep-bfb23a5e.mjs';
import { _ as _apply } from '../_chunks/dep-e769aafd.mjs';
import { _ as _baseRest } from '../_chunks/dep-8ef9fb8e.mjs';
import { _ as _baseGetTag } from '../_chunks/dep-3ca5fb38.mjs';
import { i as isObjectLike_1 } from '../_chunks/dep-c27b1c14.mjs';
import { i as isPlainObject_1 } from '../_chunks/dep-400798c5.mjs';
import { _ as _arrayMap } from '../_chunks/dep-192e10f1.mjs';
import { e as eq_1 } from '../_chunks/dep-169ea640.mjs';
import { _ as _isIterateeCall } from '../_chunks/dep-361522ee.mjs';
import { k as keys_1 } from '../_chunks/dep-10db0930.mjs';
import { _ as _basePropertyOf } from '../_chunks/dep-db11154e.mjs';
import { t as toString_1 } from '../_chunks/dep-a82b01df.mjs';
...
var _FormItem = defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    var needRequiredMark = computed(function () {
      ...
      var parentRequiredMark = (form === null || form === void 0 ? void 0 : form.requiredMark) === void 0 ? globalConfig.value.requiredMark : form === null || form === void 0 ? void 0 : form.requiredMark;
    ...
    var labelClasses = computed(function () {
      ...
      return [CLASS_NAMES.value.label, (_ref2 = {}, _defineProperty(_ref2, "".concat(FROM_LABEL.value, "--required"), needRequiredMark.value), _defineProperty(_ref2, "".concat(FROM_LABEL.value, "--colon"), hasColon.value), _defineProperty(_ref2, "".concat(FROM_LABEL.value, "--top"), hasLabel.value && (labelAlign.value === "top" || !labelWidth.value)), _defineProperty(_ref2, "".concat(FROM_LABEL.value, "--left"), labelAlign.value === "left" && labelWidth.value), _defineProperty(_ref2, "".concat(FROM_LABEL.value, "--right"), labelAlign.value === "right" && labelWidth.value), _ref2)];
    });
    ...
    var classes = computed(function () {
      ...
      return [CLASS_NAMES.value.formItem, FORM_ITEM_CLASS_PREFIX.value + (props2.name || ""), (_ref10 = {}, _defineProperty(_ref10, CLASS_NAMES.value.formItemWithHelp, helpNode.value), _defineProperty(_ref10, CLASS_NAMES.value.formItemWithExtra, extraNode.value), _ref10)];
    });
    ...
    var handleBlur = /*#__PURE__*/function () {
      var _ref11 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee6() {
