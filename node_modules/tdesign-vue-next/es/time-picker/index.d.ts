...
export declare const TimePickerPanel: {
    new (...args: any[]): {
        ...
        }>> & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "value" | "disabled" | "format" | "steps" | "hideDisabledTime" | "isFooterDisplay" | "isFocus" | "isShowPanel">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
