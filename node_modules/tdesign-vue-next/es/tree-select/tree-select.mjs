...
import { i as isBoolean_1 } from '../_chunks/dep-0f8953f7.mjs';
...
var _TreeSelect = defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    var popupClass = computed(function () {
      return ["".concat(classPrefix.value, "-select__dropdown-inner"), "".concat(classPrefix.value, "-select__dropdown"), "narrow-scrollbar"];
    });
