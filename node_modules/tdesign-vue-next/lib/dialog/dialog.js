...
var _Dialog = defineComponent({
  ...
  setup: function setup(props2, context) {
    ...
    var dialogClass = computed(function () {
      var dialogClass2 = ["".concat(COMPONENT_NAME.value), "".concat(COMPONENT_NAME.value, "--default"), "".concat(COMPONENT_NAME.value, "--").concat(props2.placement), "".concat(COMPONENT_NAME.value, "__modal-").concat(props2.theme), isModeLess.value && props2.draggable && "".concat(COMPONENT_NAME.value, "--draggable")];
      return dialogClass2;
    });
    ...
    watch(function () {
      ...
      if (value) {
        if (isModal.value && !props2.showInAttachedElement) {
          ...
          !isModeLess.value && props2.preventScrollThrough && addClass(document.body, LOCK_CLASS.value);
          nextTick(function () {
  ...
  render: function render() {
    ...
    var ctxClass = ["".concat(COMPONENT_NAME, "__ctx"), (_ref = {}, _defineProperty(_ref, "".concat(COMPONENT_NAME, "__ctx--fixed"), this.mode === "modal"), _defineProperty(_ref, "".concat(COMPONENT_NAME, "__ctx--absolute"), this.isModal && this.showInAttachedElement), _defineProperty(_ref, "".concat(COMPONENT_NAME, "__ctx--modeless"), this.isModeLess), _ref)];
