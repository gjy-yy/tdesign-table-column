...
import { defineComponent, ref, toRefs, provide, reactive, createVNode, mergeProps } from 'vue';
...
var _Dropdown = defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    var handleMenuClick = function handleMenuClick(data, context) {
      ...
      if (props2.hideAfterItemClick && popupElem.value) {
    ...
    return function () {
      ...
      var popupProps = _objectSpread(_objectSpread({}, attrs), {}, {
      ...
      return createVNode(Popup, mergeProps(props2.popupProps, popupProps, {
        "destroyOnClose": true,
        "ref": popupElem,
        ...
        content: function content() {
          return contentSlot || createVNode(_DropdownMenu, {
