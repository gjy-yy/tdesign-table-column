...
import { defineComponent, ref, computed, toRefs, onMounted, onBeforeUnmount, createVNode, Fragment, Teleport } from 'vue';
...
var _ImageViewer = defineComponent({
  ...
  setup: function setup(props2) {
    ...
    var wrapClass = computed(function () {
      return ["".concat(COMPONENT_NAME.value, "-preview-image"), _defineProperty({}, "".concat(classPrefix.value, "-is-hide"), !props2.visible)];
    });
    ...
    var renderHeader = function renderHeader() {
      return createVNode("div", {
        ...
        "class": "".concat(COMPONENT_NAME.value, "__header--pre__bt"),
    ...
    return function () {
      if (props2.mode === "modeless") {
        return createVNode(Fragment, null, [renderTNodeJSX("trigger"), createVNode(TImageViewerModal, {
      ...
      return createVNode(Fragment, null, [renderTNodeJSX("trigger"), createVNode(Teleport, {
        "to": "body"
      }, {
        "default": function _default() {
          ...
          }, null), createVNode(TImageViewerModal, null, null), images.value.length > 1 && createVNode(Fragment, null, [renderHeader(), createVNode("div", {
            "class": "".concat(COMPONENT_NAME.value, "__modal--index")
          }, ["".concat(indexValue.value + 1, "/").concat(images.value.length)]), renderNavigationArrow("prev"), renderNavigationArrow("next")]), createVNode("div", {
