    ...
    var renderThNodeList = function renderThNodeList(rowAndColFixedPosition, thWidthList) {
      ...
      return _this.thList.map(function (row, rowIndex) {
        var thRow = row.map(function (col, index) {
          ...
          var customClasses = isFunction(col.className) ? col.className(_objectSpread(_objectSpread({}, colParams), {}, {
            type: "th"
          })) : col.className;
          ...
          return createVNode("th", mergeProps({
            ...
            "class": thClasses,
            "style": styles
          }, rowspanAndColspan, resizeColumnListener), [createVNode("div", {
            "class": _this.tableBaseClass.thCellInner
          }, [col.ellipsis && col.ellipsisTitle !== false && col.ellipsisTitle !== null ? createVNode(TEllipsis, {
            "placement": "bottom",
