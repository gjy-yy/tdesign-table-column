...
import { defineComponent, toRefs, provide, reactive, ref, watchEffect, computed, createVNode, resolveComponent, mergeProps } from 'vue';
  ...
  setup: function setup(props2) {
    ...
    var renderContent = function renderContent() {
      ...
      content = options.map(function (item, index) {
        ...
        var stepItem = createVNode(resolveComponent("t-step-item"), mergeProps(item, {
          "index": stepIndex,
