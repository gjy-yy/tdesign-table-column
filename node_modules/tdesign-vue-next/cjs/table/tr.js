  ...
  methods: {
    renderEllipsisCell: function renderEllipsisCell(cellParams, params) {
      ...
      return vue.createVNode(table_ellipsis["default"], {
        ...
        "tooltipProps": _typeof__default["default"](col.ellipsis) === "object" ? col.ellipsis : void 0
    ...
    renderTd: function renderTd(params, extra) {
      ...
      var customClasses = isFunction__default["default"](col.className) ? col.className(_objectSpread(_objectSpread({}, params), {}, {
        type: "td"
      })) : col.className;
      ...
      var attrs = _objectSpread(_objectSpread({}, col.attrs), cellSpans);
