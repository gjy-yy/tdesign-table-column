...
declare const _default: import("vue").DefineComponent<{
    ...
    footerAffixProps: {
        type: PropType<import("../affix").TdAffixProps>;
    };
    footerAffixedBottom: {
        type: PropType<boolean | import("../affix").TdAffixProps>;
        default: boolean;
    };
    footerSummary: {
        type: PropType<string | ((h: typeof import("vue").h) => import("../common").SlotReturnValue)>;
    ...
    dynamicBaseTableClasses: import("vue").ComputedRef<((string | {
        [x: string]: boolean | ((h: typeof import("vue").h) => import("../common").SlotReturnValue) | import("../affix").TdAffixProps | import("./type").TableRowspanAndColspanFunc<import("./type").TableRowData>;
    })[] | {
        [x: string]: boolean;
    })[]>;
