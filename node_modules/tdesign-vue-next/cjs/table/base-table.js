...
var _BaseTable = vue.defineComponent({
  ...
  render: function render() {
    ...
    }, [vue.createVNode("colgroup", null, [columns.map(function (col) {
      var style = {
    ...
    })]), vue.createVNode(table_thead["default"], {
    ...
    var affixedFooter = Boolean(this.footerAffixedBottom && ((_this$footData = this.footData) === null || _this$footData === void 0 ? void 0 : _this$footData.length) && this.tableWidth) && vue.createVNode(affix_index.Affix, vue.mergeProps({
      ...
      "default": function _default() {
        ...
        })]), vue.createVNode(table_tfoot["default"], {
          "rowKey": _this.rowKey,
    ...
    }, [topContent]), !!(this.isVirtual || this.headerAffixedTop) && (this.headerAffixedTop ? vue.createVNode(affix_index.Affix, vue.mergeProps({
      "offsetTop": 0
    }, table_utils.getAffixProps(this.headerAffixedTop), {
      "onFixedChange": this.onFixedChange
    }), _isSlot(affixHeaderWithWrap) ? affixHeaderWithWrap : {
      "default": function _default() {
        return [affixHeaderWithWrap];
      }
    }) : this.isFixedHeader && affixHeaderWithWrap), tableContent, affixedFooter, loadingContent, this.showRightDivider && vue.createVNode("div", {
    ...
    }, null), bottom, this.horizontalScrollAffixedBottom && vue.createVNode(affix_index.Affix, vue.mergeProps({
      "offsetBottom": 0
    }, table_utils.getAffixProps(this.horizontalScrollAffixedBottom), {
      "style": {
    ...
    }), this.paginationAffixedBottom ? vue.createVNode(affix_index.Affix, vue.mergeProps({
      "offsetBottom": 0
    }, table_utils.getAffixProps(this.paginationAffixedBottom)), _isSlot(pagination) ? pagination : {
      "default": function _default() {
        return [pagination];
      }
