    ...
    var renderThNodeList = function renderThNodeList(rowAndColFixedPosition, thWidthList) {
      ...
      return _this.thList.map(function (row, rowIndex) {
        var thRow = row.map(function (col, index) {
          ...
          var customClasses = isFunction__default["default"](col.className) ? col.className(_objectSpread(_objectSpread({}, colParams), {}, {
            type: "th"
          })) : col.className;
          ...
          return vue.createVNode("th", vue.mergeProps({
            ...
            "class": thClasses,
            "style": styles
          }, rowspanAndColspan, resizeColumnListener), [vue.createVNode("div", {
            "class": _this.tableBaseClass.thCellInner
          }, [col.ellipsis && col.ellipsisTitle !== false && col.ellipsisTitle !== null ? vue.createVNode(table_ellipsis["default"], {
            "placement": "bottom",
