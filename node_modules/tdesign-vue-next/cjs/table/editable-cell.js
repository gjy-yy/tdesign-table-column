...
var EditableCell = vue.defineComponent({
  ...
  setup: function setup(props, context) {
    ...
    var componentProps = vue.computed(function () {
      ...
      if (!edit) return {};
      var editProps = isFunction__default["default"](edit.props) ? edit.props({
        col: col.value,
        row: row.value,
        rowIndex: props.rowIndex,
        colIndex: props.colIndex,
    ...
    var validateEdit = function validateEdit(trigger) {
      return new Promise(function (resolve) {
        ...
        var rules = isFunction__default["default"](col.value.edit.rules) ? col.value.edit.rules(cellParams) : col.value.edit.rules;
