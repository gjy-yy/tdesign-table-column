...
var _DatePicker = vue.defineComponent({
  ...
  setup: function setup(props2) {
    ...
    vue.watch(popupVisible, function (visible) {
      if (visible) {
        year.value = _common_js_datePicker_format.parseToDayjs(value.value || new Date(), formatRef.value.format).year();
        month.value = _common_js_datePicker_format.parseToDayjs(value.value || new Date(), formatRef.value.format).month();
        time.value = _common_js_datePicker_format.formatTime(value.value || new Date(), formatRef.value.timeFormat);
    ...
    function onConfirmClick() {
      ...
      if (nextValue) {
        onChange === null || onChange === void 0 ? void 0 : onChange(_common_js_datePicker_format.formatDate(inputValue.value, {
          ...
          dayjsValue: dayjs__default["default"](inputValue.value),
          trigger: "confirm"
        });
      } else {
