...
var _FormItem = vue.defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    var labelClasses = vue.computed(function () {
      ...
      return [CLASS_NAMES.value.label, (_ref2 = {}, _defineProperty__default["default"](_ref2, "".concat(FROM_LABEL.value, "--required"), needRequiredMark.value), _defineProperty__default["default"](_ref2, "".concat(FROM_LABEL.value, "--colon"), hasColon.value), _defineProperty__default["default"](_ref2, "".concat(FROM_LABEL.value, "--top"), hasLabel.value && (labelAlign.value === "top" || !labelWidth.value)), _defineProperty__default["default"](_ref2, "".concat(FROM_LABEL.value, "--left"), labelAlign.value === "left" && labelWidth.value), _defineProperty__default["default"](_ref2, "".concat(FROM_LABEL.value, "--right"), labelAlign.value === "right" && labelWidth.value), _ref2)];
    });
    ...
    var classes = vue.computed(function () {
      ...
      return [CLASS_NAMES.value.formItem, FORM_ITEM_CLASS_PREFIX.value + (props2.name || ""), (_ref10 = {}, _defineProperty__default["default"](_ref10, CLASS_NAMES.value.formItemWithHelp, helpNode.value), _defineProperty__default["default"](_ref10, CLASS_NAMES.value.formItemWithExtra, extraNode.value), _ref10)];
    });
