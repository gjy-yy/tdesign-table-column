...
var _Dialog = vue.defineComponent({
  ...
  setup: function setup(props2, context) {
    ...
    var dialogPosition = vue.ref(null);
    ...
    vue.watch(function () {
      ...
      if (value) {
        if (isModal.value && !props2.showInAttachedElement) {
          ...
          !isModeLess.value && props2.preventScrollThrough && utils_dom.addClass(document.body, LOCK_CLASS.value);
  ...
  render: function render() {
    ...
    var ctxClass = ["".concat(COMPONENT_NAME, "__ctx"), (_ref = {}, _defineProperty__default["default"](_ref, "".concat(COMPONENT_NAME, "__ctx--fixed"), this.mode === "modal"), _defineProperty__default["default"](_ref, "".concat(COMPONENT_NAME, "__ctx--absolute"), this.isModal && this.showInAttachedElement), _defineProperty__default["default"](_ref, "".concat(COMPONENT_NAME, "__ctx--modeless"), this.isModeLess), _ref)];
